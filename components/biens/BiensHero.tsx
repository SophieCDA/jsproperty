...
export function BiensHero({ totalProperties, availableCount }: BiensHeroProps) {
  ...
  return (
    <section className="relative bg-noir pt-32 pb-16 lg:pt-40 lg:pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* Decorative elements */}
        <div className="absolute top-1/2 left-1/4 w-96 h-96 bg-or/5 rounded-full blur-[120px] -translate-y-1/2" />
        <div className="absolute top-1/3 right-1/4 w-64 h-64 bg-azur-profond/10 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          >
            <SectionBadge text="Notre Sélection" />
          </div>
          ...
          >
            Nos Biens{" "}
            <em className="italic text-or">Disponibles</em>
          </h1>
          ...
          >
            Découvrez notre collection d'appartements et villas d'exception, 
            soigneusement sélectionnés sur les plus belles adresses de la Côte d'Azur.
          </p>
